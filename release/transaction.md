...
- Exact npm publish, Git tag creation, and GitHub release execution are not permitted by this transaction.

## Current Permission Ceiling

The current package, GitHub publish, npm wrapper, and package-candidate scope allows local editable package smoke verification, local Node wrapper proof, npm dry-run pack proof, npm publish dry-run proof, and GitHub repository push, but denies:
