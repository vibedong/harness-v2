...
14. `npm publish` exits 0 for `harness-v2@0.1.1`;
15. `git tag v0.1.1` and `git push origin v0.1.1` succeed;
16. `gh release create v0.1.1 --title "HARNESS V2 0.1.1" --notes-file RELEASE_NOTES.md` succeeds;
