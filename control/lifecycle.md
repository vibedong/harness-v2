...
```text
integration_hardening_release_preparation / goal_i_complete
```
...
- `doctor` reports integrated local surfaces and keeps release boundary closed;
